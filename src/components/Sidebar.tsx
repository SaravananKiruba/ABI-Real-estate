...
const Sidebar: React.FC = () => {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed left-0 top-0 h-full bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 text-white transition-transform duration-300 z-40 overflow-y-auto ${
